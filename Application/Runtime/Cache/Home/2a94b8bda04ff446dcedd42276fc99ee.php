...
<head>
    ...
    <![endif]-->
    <title><?php echo ($webname); ?>配货管理系统</title>
</head>
<body>
            ...
            <nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
                <ul class="cl">
                    ...
                    <li class="dropDown dropDown_hover">
                        <a href="#" class="dropDown_A"><?php echo $_SESSION['adminUser']['username'] ?> <i class="Hui-iconfont">&#xe6d5;</i></a>
                        <ul class="dropDown-menu menu radius box-shadow">
...
<aside class="Hui-aside">
    <div class="menu_dropdown bk_2">
        <dl id="menu-hotel">
            ...
            <dd>
                <ul>
                    <li><a data-href="index.php?c=hotel" data-title="酒店管理" href="javascript:void(0)">酒店管理</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-food">
        ...
        <dl id="menu-print">
            <dt><i class="Hui-iconfont">&#xe652;</i> 打印<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
            <dd>
                <ul>
        ...
        <dl id="menu-system">
            ...
            <dd>
                <ul>
                    ...
                    <li><a data-href="index.php?c=log" data-title="操作日志" href="javascript:void(0)">操作日志</a></li>
                </ul>
            </dd>
        </dl>
        <!--<dl id="menu-comments">-->
...
<section class="Hui-article-box">
    ...
    <div id="iframe_box" class="Hui-article">
        <div class="show_iframe">
            ...
            <iframe scrolling="yes" frameborder="0" src="index.php?a=welcome"></iframe>
        </div>
    </div>
</section>
...
<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="/peihuo/Public/lib/jquery.contextmenu/jquery.contextmenu.r2.js"></script>
